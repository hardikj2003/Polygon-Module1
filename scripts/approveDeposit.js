...
const ABI = require('../artifacts/contracts/Marvel.sol/Marvel.json');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("Marvel");
  const nft = await NFT.attach('0x598a7523eF50eD68dA7aea7d850bd206B82fdE13');
